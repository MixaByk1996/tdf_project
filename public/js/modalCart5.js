document.addEventListener('DOMContentLoaded', function () {
    ...
    var btn = document.getElementById("myBtn555");
    // var btn2 = document.getElementById("myBtn2");

    var span = document.getElementsByClassName("close--cart--modal5")[0];
    var modalContent = document.getElementsByClassName("modal-content--cart5")[0];
    var btn__cart = document.getElementsByClassName("btn-cart5");
    ...
    var addToCartButtons = document.querySelectorAll('.btn-cart5');
