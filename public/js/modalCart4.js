document.addEventListener('DOMContentLoaded', function () {
    ...
    var btn = document.getElementById("myBtn444");
    // var btn2 = document.getElementById("myBtn2");

    var span = document.getElementsByClassName("close--cart--modal4")[0];
    var modalContent = document.getElementsByClassName("modal-content--cart4")[0];
    var btn__cart = document.getElementsByClassName("btn-cart4");
    ...
    var addToCartButtons = document.querySelectorAll('.btn-cart4');
