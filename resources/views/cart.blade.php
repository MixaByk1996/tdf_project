                ...
                <div class="modal-body">
                                            ...
                                            {{--                                        </div>--}}
                                                                        ...
                                                                        <div class="cart-product-actions">
                                                                            <div class="cart-product-deletes-block">
                                                                                ...
                                                                                <span class="cart-product-price">{{$card->product->price}} у.е.</span>
                                                                            </div>
                    ...
                    <div class="products-item__bottom-cart">
                        <div class="products-item__bottom-cart-text">
                            ...
                            <div>Добавьте в корзину товаров на 3 297,48 у.е. для бесплатной доставки по Москве</div>
                        </div>
...
{{--                                </div>--}}
                ...
                <div class="allsum-products-container">
                    <div class="allsum-prices">
                        ...
                        <span class="allsumtextprice">{{$sum}} у.е.</span>
                    </div>
                    <div class="allsum-delivery">
                        ...
                        <span class="allsum-text-delivery">Добавьте в корзину товаров на <span class="allsum-prices-textdelivery">3 297,48 у.е.</span> для бесплатной доставки по Москве</span>
                    </div>
                </div>
            </div>
            <div class="comment-cart-container">
                ...
                <div class="comment-final-container">
                    ...
                    <div class="comment-final-item">
                        ...
                        <span class="comment-final-item-textbold-price">{{$sum}} у.е.</span>
                    </div>
