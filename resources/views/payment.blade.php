...
<section class="payment-section">
    <div class="payment-section-container">
        <div class="payment-nameses-container">
            <div class="payment-allmain-container">
                <h1 class="payment-main-text">Оплата</h1>
                <span class="catalog-main-grides-text">Главная / Корзина / Оплата</span>
            </div>
